              ...
              <div className="bg-gradient-to-br from-medical-green/10 to-medical-gold/10 rounded-3xl p-4 md:p-8 backdrop-blur">
                <div className="bg-white rounded-2xl shadow-2xl p-4 md:p-6 space-y-3 md:space-y-4">
                  ...
                  <div className="flex items-center justify-between p-3 md:p-4 bg-green-50 rounded-xl">
                    ...
                    <svg className="h-8 md:h-12 w-8 md:w-12 text-medical-green" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-8 md:py-12 bg-white border-y">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center">
            ...
            <div className="flex flex-col items-center">
              <svg className="h-10 md:h-12 w-10 md:w-12 text-medical-green mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>
              <p className="text-xs md:text-sm font-semibold text-gray-900">Verified</p>
              <p className="text-xs md:text-sm text-gray-600">Practitioners</p>
            </div>
          </div>
        </div>
      </section>
